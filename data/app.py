...
# Sample correlation data (placeholder values)
correlation_data = {
    'Fan': 0.410682,
...
with st.sidebar:
    ...
    # NEW DROPDOWN: Select City (not used in model)
    city = st.selectbox("Select City", [
        "Kolkata", "Chennai", "Hyderabad", "Bangalore", "Vizag", "Pune",
        "Mumbai", "Delhi", "Trivandrum", "Cochin", "Madurai", "Coimbatore",
        "Panaji", "Ahmedabad", "Mangalore", "Noida", "Allahabad"
    ])

    # NEW DROPDOWN: Select Month (not used in model)
...
# Fixed value (motor pump not used in UI, set to 0)
motor_pump = 0

# Model input (does NOT include city or month)
